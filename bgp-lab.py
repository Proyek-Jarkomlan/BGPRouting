...
class OSPFLab(Topo):
	...
	def build(self, *args, **kwargs):
		...
		#  AS 200 Routers
		C22 = self.addHost('C22', ip="172.16.2.2/24", defaultRoute="via 172.16.2.1")
		R21 = self.addNode("R21", cls=LinuxRouter, ip=None, privateDirs=privateDirs, inNamespace=True)
		R22 = self.addNode("R22", cls=LinuxRouter, ip=None, privateDirs=privateDirs, inNamespace=True) # Deklarasi R22 sebelum digunakan
		...
		#  AS 300 Routers
		C33 = self.addHost('C33', ip="172.16.3.2/24", defaultRoute="via 172.16.3.1")
		...
		# Links between routers in AS100 (Internal links)
		self.addLink(C11, R12, intfName1="c11-eth0", intfName2="r12-eth0")  # Client to R12
		self.addLink(R12, R14, intfName1="r12-eth1", intfName2="r14-eth0")
		self.addLink(R12, R11, intfName1="r12-eth2", intfName2="r11-eth0")
		self.addLink(R11, R13, intfName1="r11-eth2", intfName2="r13-eth1")
		self.addLink(R14, R13, intfName1="r14-eth1", intfName2="r13-eth0")

		# Links between routers in AS200 (Internal links)
		...
		# Links between routers in AS300 (Internal links)
		self.addLink(C33, R33, intfName1="c33-eth0", intfName2="r33-eth0")
		self.addLink(R33, R34, intfName1="r33-eth1", intfName2="r34-eth2")
		self.addLink(R33, R31, intfName1="r33-eth2", intfName2="r31-eth1")
		self.addLink(R34, R32, intfName1="r34-eth1", intfName2="r32-eth0")
		self.addLink(R31, R32, intfName1="r31-eth0", intfName2="r32-eth1")

		# Links between backbone routers (eBGP connections)
		self.addLink(R14, R22, intfName1="r14-eth2", intfName2="r22-eth0")  # Link between AS100 and AS200
		self.addLink(R23, R34, intfName1="r23-eth1", intfName2="r34-eth0")  # Link between AS200 and AS300
		self.addLink(R11, R31, intfName1="r11-eth1", intfName2="r31-eth2")  # Link between AS100 and AS300
